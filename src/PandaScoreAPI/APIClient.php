...
abstract class APIClient
{
	 ...
	 */
	const
		USE_LEAGUE_OF_LEGENDS = 'USE_LEAGUE_OF_LEGENDS',
		USE_COUNTER_STRIKE = 'USE_COUNTER_STRIKE',
	...
	const
		...
		self::USE_LEAGUE_OF_LEGENDS,
		self::USE_COUNTER_STRIKE,
		self::USE_DOTA_2,
		self::USE_OVERWATCH,
	],
		SETTINGS_INIT_ONLY = [
	 ...
	 * @throws GeneralException
	 */
	public function makeCall(string $method = self::METHOD_GET): PromiseInterface
	{
